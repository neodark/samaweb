...
app.controller('sectionController',['$scope', 'sectionFactory', 'authState', 'authFactory', function ($scope, sectionFactory, authState, authFactory) {
   ...
   $scope.new_course_address_january = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
   ...
   $scope.new_course_address_february = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
   ...
   $scope.new_course_address_march = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
   ...
   $scope.new_course_address_march = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
   $scope.new_course_address_april = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
   ...
   $scope.new_course_address_may = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
   ...
   $scope.new_course_address_june = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
   ...
   $scope.new_course_address_july = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
   ...
   $scope.new_course_address_august = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
   ...
   $scope.new_course_address_september = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
   ...
   $scope.new_course_address_october = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
   ...
   $scope.new_course_address_november = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
   ...
   $scope.new_course_address_december = "Martigny - Rue de Rossetan - sous la salle de gymnastique";
