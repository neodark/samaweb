...
app.directive("buttonsavecourse", function($compile)
{
	return function(scope, element, attrs)
    {
        ...
        {
            scope.save_course(scope.course_type, scope.new_course_dates, scope.new_course_time, scope.new_course_address, scope.new_course_maximum_participants, scope.new_course_price);
		});
    }
});
...
app.directive("buttonupdatecourse", function($compile)
{
	return function(scope, element, attrs)
    {
		...
		element.bind("click", function()
        {
            ...
            scope.update_course(scope.singleCourse.id, scope.course_type, scope.new_course_dates, scope.new_course_time, scope.new_course_address, scope.new_course_maximum_participants, scope.new_course_price, action);
		});
    }
});
